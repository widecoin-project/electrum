...
```
$ adb shell
$ run-as org.electrum_wcn.electrum_wcn ls /data/data/org.electrum_wcn.electrum_wcn/files/data
$ run-as org.electrum_wcn.electrum_wcn cp /data/data/org.electrum_wcn.electrum_wcn/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
